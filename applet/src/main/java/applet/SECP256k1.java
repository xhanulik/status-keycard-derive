...
Original source: https://github.com/status-im/status-keycard/blob/master/src/main/java/im/status/keycard/SECP256k1.java
...
public class SECP256k1 {
    ...
    public KeyAgreement ecPointMultiplier;
